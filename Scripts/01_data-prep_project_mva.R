...
# #############################
##  Script name: data-prep_project_mva.R
# #############################
...
ZIP_lst <- as.character(c("00501","00544","10001":"14999"))
...
#agency_acronym <-unique(protoY[,4:5])
...
cat("Complaints processing ended.\n")
...
target_filename <- paste0("Data/",proc_filename,"02.csv") 
csvSaveF(Y_wk,target_filename)                                          # csv to disk
